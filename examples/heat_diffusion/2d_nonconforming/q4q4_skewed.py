...
fens1, fes1 = t3_ablock(0.5, 1, int(N1 / 2), N1)
...
xys = np.unique(np.vstack([fens1.xyz[boundary_nodes1_], fens2.xyz[boundary_nodes2_]]), axis=0)
ys_i = xys[:,1]
xs_i = xys[:,0]
fens_i, fes_i = l2_blockx_2D(xs_i, ys_i)
